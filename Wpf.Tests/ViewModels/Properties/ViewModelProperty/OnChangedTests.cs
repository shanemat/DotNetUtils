...
/// <summary>
/// Contains tests for <see cref="ViewModelProperty{T}.OnChanged"/> method
/// </summary>
internal sealed class OnChangedTests
{
	...
	public void ShouldRaisePropertyChangedEventForIsApplicableProperty()
	{
		...
		{
			if( e.PropertyName != nameof( ViewModelProperty<int>.IsApplicable ) )
				return;
	...
	public void ShouldRaisePropertyChangedEventForIsReadOnlyProperty()
	{
		...
		void OnPropertyChanged( object? sender, PropertyChangedEventArgs e )
		{
			if( e.PropertyName != nameof( ViewModelProperty<int>.IsReadOnly ) )
				return;
	...
	public void ShouldRaisePropertyChangedEventForDisplayNameProperty()
	{
		...
		void OnPropertyChanged( object? sender, PropertyChangedEventArgs e )
		{
			if( e.PropertyName != nameof( ViewModelProperty<int>.DisplayName ) )
				return;
